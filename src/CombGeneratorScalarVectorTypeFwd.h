/**
 * @file CombGeneratorScalarVectorTypeFwd.h
 * @brief The Forward Declaration for the Comb Generator Scalar Vector Data Type
 * @authors Frank Reiser
 * @date Initiated December 27th, 2022
 */

#ifndef REISERRT_COMBGENERATOR_COMBGENERATORSCALARVECTORTYPEFWD_H
#define REISERRT_COMBGENERATOR_COMBGENERATORSCALARVECTORTYPEFWD_H
...
namespace ReiserRT
{
    ...
    {
        /**
         * @brief Forward Declaration for the CombGenerator Scalar Vector Type
         *
         ...
         */
        using CombGeneratorScalarVectorType = std::shared_ptr< const double[] >;
    }
}

#endif //REISERRT_COMBGENERATOR_COMBGENERATORSCALARVECTORTYPEFWD_H
